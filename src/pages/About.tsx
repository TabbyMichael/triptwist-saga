      ...
      <div className="prose max-w-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="text-center">
            <img src="https://source.unsplash.com/featured/400x300/?travel,planning" alt="Travel Planning" className="rounded-lg mb-4" />
            <h3 className="text-xl font-semibold mb-2">Smart Planning</h3>
            <p>Intuitive tools for creating the perfect itinerary</p>
          </div>
          <div className="text-center">
            <img src="https://source.unsplash.com/featured/400x300/?travel,destination" alt="Destinations" className="rounded-lg mb-4" />
            <h3 className="text-xl font-semibold mb-2">Global Destinations</h3>
            <p>Discover amazing places around the world</p>
          </div>
          <div className="text-center">
            <img src="https://source.unsplash.com/featured/400x300/?travel,experience" alt="Experiences" className="rounded-lg mb-4" />
